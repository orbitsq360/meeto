# !/bin/bash
# Copyright 2024 The RTC Labs - All Rights Reserved
...
# jupitermeet installation for ubuntu 22.04
function ubuntu_22_04 {
    ...
    apt install php8.1 php8.1-mbstring php8.1-mysqli php8.1-curl php8.1-dom php8.1-xml php8.1-xmlwriter php8.1-common php8.1-json php8.1-zip php8.1-bcmath php8.1-gettext -y
...
" > /etc/turnserver.conf
    ...
    echo ""
    if dpkg -s php8.1 &> /dev/null
    then
    echo -e "PHP8.1    : ${LIGHTGREEN}Installed${NOCOLOR}"
    else
    echo -e "PHP8.1    : ${LIGHTRED}Not installed${NOCOLOR}"
    fi
    echo ""
...
if [ -f /etc/lsb-release ]; then
    ...
    if [ $vernum == 22.04 ]; then
        ...
        if [ -f jupitermeet.zip ]; then
            ...
            # install jupitermeet on ubuntu 22.04
            ubuntu_22_04
